...
$config['LicenseName'] = 'drupal';
$config['LicenseKey'] = 'KABCDE32FG69RKINTPPBTBAUY2U7ZN1DE3LXXPD8F1T247TZZ';
...
$baseUrl = substr($phpSelf, 0, strpos($phpSelf, 'bower_components')).'upload/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'flv,mp4,mov,f4v,3gp',
		'deniedExtensions' => '');
